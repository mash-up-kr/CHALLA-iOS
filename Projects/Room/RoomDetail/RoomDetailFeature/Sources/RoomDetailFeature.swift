...
public struct RoomDetailFeature {
    ...
    public var body: some ReducerOf<Self> {
        ...
        Reduce { state, action in
            ...
            case let .photosResponse(.success(photos)):
                ...
                guard state.highlightsNewestPhoto, let newest = photos.last else { return .none }
    ...
    private enum CancelID { case detail, photos, toast, printRefresh, prepareShoot, highlight }
