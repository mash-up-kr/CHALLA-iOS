...
struct InviteCodeRuleTests {
    ...
    func trimsWhitespace() {
        #expect(InviteCodeRule.normalize("  1928121  ") == "1928121")
        #expect(InviteCodeRule.normalize("\n1928121\t") == "1928121")
    }

    @Test("공백 외에는 입력값을 바꾸지 않는다")
    func keepsInputAsIs() {
        #expect(InviteCodeRule.normalize("challa1") == "challa1")
        #expect(InviteCodeRule.normalize("ChAlLa1") == "ChAlLa1")
        #expect(InviteCodeRule.normalize(" a3f9k2 ") == "a3f9k2")
    }
