...
/// 계정 관리 화면 맨 위의 프로필 요약 — 아바타 + 닉네임 + 이메일을 가운데 정렬로 쌓는다.
///
...
private enum Metric {
    ...
    static let emailTypography = CHALLATypography.body.medium.regular
